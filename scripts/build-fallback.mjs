#!/usr/bin/env node
/* ============================================================
   build-fallback.mjs: the stylesheet for the two pages that
   cannot have one.

       node scripts/build-fallback.mjs           # write it
       node scripts/build-fallback.mjs --check   # or compare
...
export function generate() {
  ...
  return `/* GENERATED by scripts/build-fallback.mjs. Do not edit.
