...
const PUBLIC: Record<string, string> = {
  ...
  "place.ts":
    "a town by name, for the research lab's climate series: a name in and "
    + "a list of names and coordinates out, rounded to about a kilometre. It "
    + "takes no bearer, writes nothing, stores nothing and knows nobody. The "
    + "browser may not call the index itself because `connect-src` is 'self', "
