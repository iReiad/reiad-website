/* ============================================================
   ...
   The shell. What is inside `#studio-root` is still the Vite
   bundle at `/studio/app.js`, built from `app/src/studio/**` and
...
export const metadata: Metadata = {
  ...pageMeta({
    ...
    title: "Article Studio · Reiad's Library",
    description: "Paste an article, clean it up, resize the photos and publish it.",
    ogTitle: "Article Studio",
    card: "default",
  }),
...
export default function Page() {
  return (
    <main id="main">
      ...
      <div className="wrap" id="studio-root" hidden />
    </main>
  );
}
