  ...
  return (
      ...
      <main id="main">
        <div className="wrap">
            ...
            <aside className="id-card">
              <span className="id-mark" aria-hidden="true">
                <svg viewBox="0 0 100 100" fill="none">
                  ...
                  <circle cx="63" cy="24" r="5.5" fill="var(--gold)" />
                </svg>
              </span>
          ...
          <div className="band">
            <span className="mono">Elsewhere
            </span>
            <h2>Recruiters, clients, or a reader with a question
            </h2>
            <p>All three are welcome. The contact form lands straight in his inbox, and
           he answers within a business day.
            </p>
            <div className="hero-actions">
              <a className="btn btn-solid" href="/contact.html">Get in touch
              </a>
              <a className="btn btn-ghost" href="mailto:i@reiad.co.uk">i@reiad.co.uk
              </a>
            </div>
            <ul className="social social-band" aria-label="Elsewhere on the web">
              <li>
