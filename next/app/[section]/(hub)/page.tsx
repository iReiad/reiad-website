...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  if (BUILT.has(section)) {
    ...
    return {
      ...
      alternates: { canonical: `${origin}/money` },
      openGraph: {
        type: "website",
