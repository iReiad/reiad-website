/* ============================================================
   /deutsch/<stufe>/arbeitsbuch.html: the German practice book.

   A static segment beside `[lesson]`, which is what stops the
   book being read as a Teil called "arbeitsbuch": a static
...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  return workbookMeta(slug, `/${section}/${slug}/arbeitsbuch.html`);
}
