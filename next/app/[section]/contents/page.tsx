/* ============================================================
   /money/contents, the money school's full index.

   A static segment beside `[slug]` under `[section]`, which is
   what makes `/money/contents` the index and `/money/basics-1` a
   stage. It answers only where a school has one. Today that is the money
...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  const url = `${origin}/money/contents`;
