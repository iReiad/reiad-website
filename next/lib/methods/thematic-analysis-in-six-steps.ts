...
<li>Braun and Clarke's six phases: familiarising, initial coding, searching for themes, reviewing, defining and naming themes, writing up.</li>
...
<p>Thematic analysis finds patterns of meaning across qualitative data and reports them as themes. Braun and Clarke's version, taught most widely and the one this lesson follows, treats the analyst as an active participant in that finding rather than a neutral extractor of what was already there. Two people can code the same interviews well and come back with different themes, because a theme is an argument about what matters, built from codes, and an argument has an author. That is not a weakness to apologise for; it is why the write up has to show the reasoning and not only the result. The six phases are not a straight line walked once: you will return to phase two after phase four shows a code that should have caught something it missed, which Braun and Clarke call recursive.</p>

<h2>Code against theme</h2>
<p>A code is a short label on a passage: a word or phrase capturing one thing it is doing or saying. A theme is bigger: a pattern recurring across many codes, organised around a shared idea, and a claim you are making about the data rather than a tag found in it. Coding is close and mechanical, done first; theming is the interpretive step after, built out of the codes.</p>
<p>The commonest mistake is calling a topic a theme. "Money" is a topic: it names a subject people talked about and says nothing about what they said. "Money runs out before the harvest does" is closer to a theme, because it makes a claim the codes underneath can support or contradict. A theme should be arguable, not merely present.</p>
...
<p>Inductive coding starts from the data with no framework decided in advance: codes are whatever the transcripts call for, and themes are built from those codes alone. Deductive coding starts from an existing framework, a theory or set of categories from the literature, and asks whether the data support, extend or contradict it. Most real projects sit between the two. Say plainly which way you leaned, because a reader needs to know whether they are reading what the data suggested or what the framework was looking for.</p>

<h2>The reflexive stance</h2>
<p>Reflexive thematic analysis does not treat researcher judgement as an error to be minimised: it treats it as the instrument doing the analysis, and asks you to be explicit about it. A reflexive note kept alongside the coding, a few lines after each transcript on what you noticed reacting to and why you changed your mind on a passage, lets a reader, and later you, tell a defensible interpretation from one you have simply gotten used to. This is also why two coders reaching different themes is not by itself a problem: Braun and Clarke say inter-rater reliability, from a tradition built for counting, is the wrong test here. Check instead whether the extracts support the claim, and whether you have said honestly where your own position shaped the reading.</p>

<h2>Saturation, said honestly</h2>
<p>Saturation is the point where further transcripts stop changing your account: new interviews confirm the themes you already have rather than adding new ones. It is a judgement from what the last few transcripts actually contributed, not a sample size fixed before fieldwork starts. A proposal stating "saturation will be reached at fifteen interviews" promises a number the data have not been allowed to decide. Say instead what was watched for: that the final few transcripts were coded to check whether they introduced anything the existing themes could not absorb, a claim checkable against your own coding record.</p>
...
<p>থিম্যাটিক বিশ্লেষণ কোয়ালিটেটিভ তথ্য জুড়ে অর্থের ধরন খুঁজে বের করে আর সেগুলোকে বিষয় হিসেবে লেখে। সবচেয়ে বেশি পড়ানো Braun আর Clarke-এর ভাষ্যে, যা এই পাঠ অনুসরণ করছে, বিশ্লেষককে ধরা হয় সক্রিয় অংশগ্রহণকারী, তথ্যে আগে থেকে বসে থাকা কিছুর নিরপেক্ষ সংগ্রাহক নয়। দুজন মানুষ একই সাক্ষাৎকার ভালোভাবে কোড করে আলাদা বিষয়ে পৌঁছাতে পারেন, কারণ বিষয় মানে কী গুরুত্বপূর্ণ তা নিয়ে একটা যুক্তি, কোড থেকে বানানো, আর যুক্তির একজন লেখক থাকে। এটা দুর্বলতা নয়, এই কারণেই লেখাটায় শুধু ফলাফল নয়, যুক্তিটাও দেখাতে হয়। ছয়টা ধাপ একবার হাঁটার মতো সোজা রাস্তা নয়: চার নম্বর ধাপে এমন কোড দেখবেন যা দুই নম্বরে ধরা উচিত ছিল, আর তখন সেখানে ফিরে যাবেন, যাকে Braun আর Clarke রিকার্সিভ বলেন।</p>
...
<li><strong>লিখে ফেলা।</strong> এমন অংশ বেছে নিন যা বিষয়টা স্পষ্ট বহন করে, আর তার চারপাশে বিশ্লেষণী বর্ণনা লিখুন, উদ্ধৃতির দেয়াল দিয়ে যুক্তির জায়গা পূরণ করবেন না। প্রতিটা অংশ বিষয়টা দেখাবে, প্রসঙ্গের উল্লেখ নয়।</li>
</ol>

<h2>ইনডাক্টিভ বনাম ডিডাক্টিভ</h2>
<p>ইনডাক্টিভ কোডিং তথ্য থেকে শুরু হয়, আগে থেকে কাঠামো ঠিক না করে: কোডগুলো ট্রান্সক্রিপ্ট যা দাবি করে তা-ই, বিষয়গুলো শুধু সেই কোড থেকে বানানো। ডিডাক্টিভ কোডিং শুরু হয় আগে থেকে থাকা কাঠামো দিয়ে, সাহিত্য থেকে নেওয়া তত্ত্ব বা বিভাগের সেট দিয়ে, আর জিজ্ঞেস করে তথ্য সেটাকে সমর্থন করে কি না। বেশিরভাগ প্রকল্প মাঝামাঝি থাকে। স্পষ্ট বলুন কোন দিকে বেশি ঝুঁকেছিলেন, কারণ পাঠকের জানা দরকার তথ্য যা বলল তা পড়ছেন নাকি কাঠামো যা খুঁজছিল তা।</p>

<h2>রিফ্লেক্সিভ অবস্থান</h2>
<p>রিফ্লেক্সিভ থিম্যাটিক বিশ্লেষণ গবেষকের বিচারবুদ্ধিকে কমাতে হবে এমন ভুলের উৎস হিসেবে দেখে না: এটাকে বিশ্লেষণ করা যন্ত্র হিসেবে দেখে, আর স্পষ্ট থাকতে বলে। কোডিং-এর পাশে রাখা রিফ্লেক্সিভ নোট, প্রতিটা ট্রান্সক্রিপ্টের পর কয়েক লাইনে নিজের প্রতিক্রিয়া আর কেন মত বদলালেন তা লেখা, পাঠককে আর পরে নিজেকেও বলে দেয় কোন ব্যাখ্যা রক্ষা করা যায় আর কোনটায় শুধু অভ্যস্ত হয়ে গেছেন। এই কারণেই দুজন কোডার আলাদা বিষয়ে পৌঁছালে তা সমস্যা নয়: Braun আর Clarke বলেন, গোনার জন্য বানানো ঐতিহ্য থেকে ধার করা ইন্টার-রেটার রিলায়াবিলিটি এখানে ভুল পরীক্ষা। পাঠক যাচাই করবেন অংশগুলো দাবিটা সমর্থন করে কি না, আর নিজের অবস্থান পড়াটাকে কোথায় গড়ে দিতে পারত তা সৎভাবে বলা হয়েছে কি না।</p>

<h2>স্যাচুরেশন, সৎভাবে বলা</h2>
<p>স্যাচুরেশন সেই বিন্দু, যেখানে আরও ট্রান্সক্রিপ্ট আপনার বিবরণ বদলানো বন্ধ করে দেয়: নতুন সাক্ষাৎকার আগে থাকা বিষয় নিশ্চিত করে, নতুন কিছু যোগ করে না। এটা শেষের কয়েকটা ট্রান্সক্রিপ্ট আসলে কী যোগ করল তা দেখে করা বিচার, মাঠকাজের আগে ঠিক করা নমুনার আকার নয়। প্রস্তাবে লেখা "পনেরোটা সাক্ষাৎকারে স্যাচুরেশন পাওয়া যাবে" সংখ্যার প্রতিশ্রুতি দেয় যা তথ্যকে এখনো ঠিক করতে দেওয়া হয়নি। এর বদলে বলুন আসলে কী খেয়াল করা হয়েছিল: শেষের কয়েকটা ট্রান্সক্রিপ্ট বর্তমান বিষয় নিতে না পারা কিছু এল কি না দেখতে কোড করা হয়েছিল, নিজের কোডিং রেকর্ডের বিপরীতে যাচাই করা যায় এমন একটা দাবি।</p>
...
<p>ছয়টা কোড থেকে বানানো দুটো বিষয়, বৃষ্টি, জ্ঞান আর দেনা এই তিন প্রসঙ্গ থেকে নয়। <strong>"পুরোনো সময় বোঝা আর কাজ করছে না"</strong> প্রথম দুই লাইনকে জড়ো করে: দুটোই মৌসুম পড়ার একটা পদ্ধতি বর্ণনা করে, যা আর নির্ভরযোগ্য উত্তর দেয় না। এটা বিষয়, প্রসঙ্গ নয়, কারণ এটা একটা ভাগাভাগি ব্যর্থতা দাবি করে, শুধু বৃষ্টি আর জ্ঞানের কথা উঠেছে তা নয়। <strong>"খারাপ মৌসুমের দাম দুইবার দিতে হয়"</strong> তৃতীয় লাইনটাকে প্রথম লাইনের দ্বিতীয় অংশের সঙ্গে জড়ো করে: বেশিদিন থাকা বৃষ্টি দ্বিতীয়বার বোনায় বাধ্য করে, আর সেই বোনা কেনা হয় দেনা দিয়ে যা সাধারণ ফসলে শোধ হবে না। দাবিটা হলো দাম শুধু হারানো ফসল নয়, আবার চেষ্টা করার দেনাও, যা তৃতীয় লাইনটা একা শুধু ইঙ্গিত দিত।</p>
</div>
