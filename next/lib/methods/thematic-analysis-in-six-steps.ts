...
<p>Inductive coding starts from the data with no framework decided in advance: codes are whatever the transcripts call for, and themes are built from those codes alone. Deductive coding starts from an existing framework, a theory or a set of categories from the literature, and asks whether the data support, extend or contradict it. Most real projects sit between the two, a framework held loosely enough that an unpredicted code still gets written down. Say plainly which way you leaned, because a reader needs to know whether they are reading what the data suggested or what the framework was looking for.</p>

<h2>The reflexive stance</h2>
<p>Reflexive thematic analysis does not treat researcher judgement as an error to be minimised. It treats it as the instrument doing the analysis, and asks you to be explicit about it. A reflexive note kept alongside the coding, a few lines after each transcript on what you noticed yourself reacting to and why you changed your mind on a passage, lets a reader, and later you, tell the difference between a defensible interpretation and one you have simply gotten used to. This is also why two coders reaching different themes from the same transcripts is not by itself a problem: Braun and Clarke are explicit that inter-rater reliability, borrowed from a tradition built for counting, is the wrong test here. A reader should instead check whether the extracts really do support the claim, and whether you have said honestly where your own position might have shaped the reading.</p>
...
<p>ইনডাক্টিভ কোডিং তথ্য থেকে শুরু হয়, আগে থেকে কাঠামো ঠিক না করে: কোডগুলো ট্রান্সক্রিপ্ট যা দাবি করে তা-ই, বিষয়গুলো শুধু সেই কোড থেকে বানানো। ডিডাক্টিভ কোডিং শুরু হয় আগে থেকে থাকা কাঠামো দিয়ে, সাহিত্য থেকে নেওয়া তত্ত্ব বা বিভাগের সেট, আর জিজ্ঞেস করে তথ্য সেটাকে সমর্থন করে কি না। বেশিরভাগ প্রকল্প মাঝামাঝি থাকে: মাথায় বড় কাঠামো, কিন্তু এতটা শিথিল যে অপ্রত্যাশিত কোডও লেখা হয়। স্পষ্ট বলুন কোন দিকে বেশি ঝুঁকেছিলেন, কারণ পাঠকের জানা দরকার তথ্য যা বলল তা পড়ছেন নাকি কাঠামো যা খুঁজছিল তা।</p>

<h2>রিফ্লেক্সিভ অবস্থান</h2>
<p>রিফ্লেক্সিভ থিম্যাটিক বিশ্লেষণ গবেষকের বিচারবুদ্ধিকে কমাতে হবে এমন ভুলের উৎস হিসেবে দেখে না। এটাকে বিশ্লেষণ করা যন্ত্র হিসেবে দেখে, আর তার বদলে সেটা নিয়ে স্পষ্ট থাকতে বলে। কোডিং-এর পাশে রাখা রিফ্লেক্সিভ নোট, প্রতিটা ট্রান্সক্রিপ্টের পর কয়েক লাইনে নিজের প্রতিক্রিয়া আর কেন মত বদলালেন তা লেখা, একজন পাঠককে আর পরে নিজেকেও বলে দেয় কোন ব্যাখ্যা রক্ষা করা যায় আর কোনটায় শুধু অভ্যস্ত হয়ে গেছেন। এই কারণেই দুজন কোডার আলাদা বিষয়ে পৌঁছালে তা নিজে থেকে সমস্যা নয়: Braun আর Clarke বলেন, গোনার জন্য বানানো ঐতিহ্য থেকে ধার করা ইন্টার-রেটার রিলায়াবিলিটি এখানে ভুল পরীক্ষা। পাঠক এর বদলে যাচাই করবেন অংশগুলো দাবিটা সমর্থন করে কি না, আর নিজের অবস্থান পড়াটাকে কোথায় গড়ে দিতে পারত তা সৎভাবে বলা হয়েছে কি না।</p>
