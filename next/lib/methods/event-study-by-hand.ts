...
<ul>
<li>Letting the estimation window run up to the event, so alpha and beta already carry the run-up.</li>
<li>Reporting a CAR with no t statistic beside it.</li>
<li>Treating several firms that share one event date as several independent tests.</li>
<li>Crediting the whole CAR to the event without checking for other news in the same window.</li>
...
<p class="note">আলফা, বিটা আর রেসিডুয়াল স্ট্যান্ডার্ড ডেভিয়েশন যতটা ভালো, এস্টিমেশন উইন্ডোটা যেখান থেকে এসেছে ততটাই ভালো। উইন্ডোটা নিজেই যদি একটা অধিগ্রহণের গুজব বা আগের কোনো কেলেঙ্কারির ভেতরে বসে থাকে, তাহলে ইভেন্ট উইন্ডো এমন একটা মডেল পাবে যা আসলে কখনও শান্ত ছিলই না।</p>
...
<li>একই তারিখ ভাগ করা কয়েকটা কোম্পানিকে কয়েকটা স্বাধীন পরীক্ষা হিসেবে ধরা।</li>
<li>একই উইন্ডোয় অন্য খবর আছে কি না না দেখেই CAR-এর কৃতিত্ব ইভেন্টটাকে দেওয়া।</li>
