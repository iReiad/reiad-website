...
export const RESEARCH_TOOLS: ResearchTool[] = [
  ...
  { slug: "table-maker", name: { en: "Table maker", bn: "টেবিল বানান" }, dek: { en: "A grid to Markdown, HTML, LaTeX and Word.", bn: "একটা ছক থেকে Markdown, HTML, LaTeX আর Word।" }, tone: "plum", room: "write" },
  { slug: "equation", name: { en: "Equation editor", bn: "সমীকরণ সম্পাদক" }, dek: { en: "LaTeX in, KaTeX out, kept as source and copied for the desk.", bn: "LaTeX লিখুন, KaTeX-এ দেখুন, সোর্স হিসেবে রাখা আর ডেস্কের জন্য কপি।" }, tone: "plum", room: "write" },
