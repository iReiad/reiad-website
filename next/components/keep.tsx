...
/* ============================================================
   ...
   `archive/modules/keep.ts` was 220 lines that built this row
   with `document.createElement` and inserted it after `.byline`,
   which is the shape `components/scripts.tsx` is entirely about: a node
