/* ============================================================
   editor.js: the writing surface, on its own.
 ...
 * @param {HTMLElement} options.root       the contenteditable
 * @param {() => void}  options.onChange   something changed, redraw
 * @param {() => string} options.lang      "en" or "bn", for block copy
 * @param {(msg: string) => void} options.toast
 * @param {() => void}  options.pickPhoto  open the file picker
 * @param {() => void}  [options.onSave]    Ctrl+S
 * @param {() => void}  [options.onPublish] Ctrl+Enter
 */
