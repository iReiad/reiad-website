...
const MONEY_STAGES = [
    {
        ...
        blurb: "আট ধাপে বাংলাদেশে বিনিয়োগ শুরু করার পুরো পথ, কোন কাজটা আপনার, কোনটা অন্যরা করে দেবে, আর কোন ধাপে ঝুঁকি কতটা।",
        needs: [],
        status: "live",
        sections: [
            {
    ...
    },
    {
        ...
        blurb: "বাজারের আঠারোটা শব্দ, প্রতিটার আলাদা ছোট লেখা, বন্ধুকে বোঝানোর ভঙ্গিতে। একটার ভেতরে আরেকটার লিংক।",
        needs: ["start"],
        status: "live",
        sections: [
            {
    ...
    },
    {
        ...
        blurb: "বাংলাদেশে তথ্য কোথায় পাওয়া যায়, রিপোর্ট কীভাবে পড়তে হয়, আর একটা কোম্পানি নিয়ে সৎভাবে সিদ্ধান্তে আসার পদ্ধতি।",
        needs: ["basics-2"],
        status: "live",
        sections: [
            {
...
export const stageUrl = (stage) => `/money/${stage.slug}/index.html`;
