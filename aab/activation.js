...
function activationStart(entry) {
    if (typeof entry === "object" && entry !== null && "activationStart" in entry) {
        const value = entry.activationStart;
...
export const wasPrerendered = () => activationStart(performance.getEntriesByType("navigation")[0]) > 0;
/**
