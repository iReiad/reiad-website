...
function drawMaterial(ctx, p, hasPhoto, drawn) {
    if (!hasPhoto) {
        /* ---- 1. sky ---- */
        ...
        if (drawn.motif) {
            ...
            ctx.drawImage(drawn.motif, STAGE.x - 128, STAGE.y - 26, STAGE.w + 256, STAGE.h + 40);
            ctx.restore();
        }
