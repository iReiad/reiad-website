...
const videoEmbed = (drive: string) => `https://drive.google.com/file/d/${drive}/preview`;
const fileUrl = (drive: string) => `https://drive.google.com/file/d/${drive}/view`;
...
function drawLesson(root: HTMLElement, course: Course, mod: Module, lesson: Lesson) {
  ...
  if (lesson.transcript) {
    extras.push(el("li", {}, [
      el("a", { href: fileUrl(lesson.transcript), target: "_blank", rel: "noopener" },
        ["Transcript"]),
