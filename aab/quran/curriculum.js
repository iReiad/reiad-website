        ...
        lessons: [
            {
                ...
                icon: "three",
                minutes: 7,
                blurb: "প্রতিটি আরবি শব্দ তিনটির একটি: নাম, কাজ, বা ছোট শব্দ। এইটুকু চিনলেই বাক্যের কাঠামো চোখে পড়তে শুরু করে।",
            },
            {
                slug: "sorbonam",
                from: 2,
                ...
                icon: "person",
                minutes: 7,
                blurb: "هُوَ আর هِيَ দিয়ে শুরু। ছেলে আর মেয়ের জন্য আলাদা শব্দ, আর এটাই আরবির নিয়ম।",
            },
            {
                slug: "purush-stri",
                from: 3,
                ...
                icon: "pair",
                minutes: 7,
                blurb: "শব্দের শেষে গোল ة থাকলে বেশির ভাগ সময় সেটা স্ত্রী-লিঙ্গ। আপাতত শুধু চিহ্নটা চিনে রাখা।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "link",
                minutes: 8,
                blurb: "رَبُّهُ, رَبُّكَ, رَبِّي। ছোট একটা অংশ শব্দের শেষে জুড়ে বসে, আর আলাদা শব্দ লাগে না।",
            },
            {
                slug: "ei-oi",
                from: 5,
                ...
                icon: "hand",
                minutes: 6,
                blurb: "কাছের জিনিসে هٰذَا, দূরের জিনিসে ذٰلِكَ। কুরআনের সবচেয়ে বেশি আসা শব্দগুলোর একটা এখানেই।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "bridge",
                minutes: 7,
                blurb: "নিজে বড় কিছু নয়, কিন্তু কুরআনের প্রায় প্রতিটি লাইনে আছে। দশটা শব্দ, আর পথের অর্ধেক।",
            },
            {
                slug: "jora-sorbonam",
                from: 7,
                ...
                icon: "merge",
                minutes: 7,
                blurb: "لَـ আর ـهُ মিলে لَهُ, فِي আর ـهِ মিলে فِيهِ। গতকালের দুই জিনিস আজ মিশে যাচ্ছে।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "star",
                minutes: 8,
                blurb: "কুরআনে অল্প কিছু নাম-শব্দই বারবার ফিরে আসে। সেই চৌদ্দটা, আর আল্লাহর আটটা সুন্দর নাম।",
            },
            {
                slug: "al",
                from: 9,
                ...
                icon: "ring",
                minutes: 7,
                blurb: "الـ বসলে 'একটা' হয়ে যায় 'সেই', ঠিক বাংলার 'বই' আর 'বইটি'। আর কখনো 'ল' শোনা যায় না।",
            },
            {
                slug: "shob-ekshathe",
                from: 10,
                ...
                icon: "open-book",
                minutes: 9,
                blurb: "বিসমিল্লাহ, আলহামদু লিল্লাহ, আর কুল হুওয়াল্লাহু আহাদ। দশ দিনের সব টুকরো তিনটি আয়াতে।",
            },
        ],
    },
];
        ...
        lessons: [
            {
                ...
                icon: "root",
                minutes: 8,
                blurb: "বেশির ভাগ আরবি শব্দ তিন অক্ষরের একটা মূল থেকে জন্মায়। মূল চিনলে অচেনা শব্দও আন্দাজ করা যায়।",
            },
            {
                slug: "chanch",
                from: 2,
                ...
                icon: "mould",
                minutes: 8,
                blurb: "শব্দের আকার মাপতে আরবি ব্যবহার করে ف · ع · ل। একই মূল, আলাদা ছাঁচ, আলাদা মানে।",
            },
            {
                slug: "dorkari-chanch",
                from: 3,
                ...
                icon: "mould",
                minutes: 9,
                blurb: "কর্তা, কর্ম, জায়গা, যন্ত্র। আর আল্লাহর যে নামগুলো তুমি চেনো, সেগুলোও আসলে ছাঁচেই বসানো।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "clock",
                minutes: 8,
                blurb: "একই মূল থেকে তিন রকম ক্রিয়া: সে করল, সে করে, আর করো। কখন হলো, তার তিন চেহারা।",
            },
            {
                slug: "otit",
                from: 5,
                ...
                icon: "back",
                minutes: 9,
                blurb: "চেনা সর্বনামগুলোই ফিরে এলো, এবার ক্রিয়ার শেষে জুড়ে। فَعَلَ, فَعَلْتَ, فَعَلْتُ।",
            },
            {
                slug: "bortoman",
                from: 6,
                ...
                icon: "forward",
                minutes: 9,
                blurb: "এবার চিহ্নটা সামনে বসে: أ · ن · ي · ت। সামনে দেখলেই বুঝবে এটা বর্তমান।",
            },
            {
                slug: "adesh",
                from: 7,
                ...
                icon: "call",
                minutes: 7,
                blurb: "قُلْ, اقْرَأْ, اذْكُرْ। কুরআনের অনেক আয়াত এই এক শব্দ দিয়েই শুরু হয়।",
            },
            {
                slug: "na-bodhok",
                from: 8,
                ...
                icon: "no",
                minutes: 7,
                blurb: "ছোট একটা শব্দ সামনে বসিয়ে ক্রিয়াকে 'না' করে দেওয়া: لَا, مَا, لَمْ, لَنْ।",
            },
            {
                slug: "korta-vitore",
                from: 9,
                ...
                icon: "seed",
                minutes: 7,
                blurb: "আরবির একটা সুন্দর মিতব্যয়িতা: কে করছে সেটা ক্রিয়ার ভেতরেই লেখা থাকে, আলাদা শব্দ লাগে না।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "two",
                minutes: 7,
                blurb: "নাম দিয়ে শুরু হলে নাম-বাক্য, কাজ দিয়ে শুরু হলে কাজ-বাক্য। পুরো আরবি এই দুই ভাগে।",
            },
            {
                slug: "nam-bakko",
                from: 11,
                ...
                icon: "equals",
                minutes: 8,
                blurb: "اللهُ غَفُورٌ। দুটো শব্দ পাশাপাশি বসলেই বাক্য, মাঝখানে কোনো ক্রিয়া লাগে না। বাংলার মতোই।",
            },
            {
                slug: "kaj-bakko",
                from: 12,
                ...
                icon: "engine",
                minutes: 8,
                blurb: "প্রথমে ক্রিয়া, তারপর কর্তা, তারপর কর্ম। বাংলার উল্টো, আর অভ্যাস হয়ে গেলে সহজ।",
            },
            {
                slug: "idafa",
                from: 13,
                ...
                icon: "link",
                minutes: 8,
                blurb: "দুটো নাম-শব্দ পাশাপাশি বসিয়ে 'X-এর Y' বোঝানো: رَبُّ العَالَمِينَ।",
            },
            {
                slug: "bisheshon",
                from: 14,
                ...
                icon: "pair",
                minutes: 9,
                blurb: "বিশেষণ নাম-শব্দের পরে বসে আর তার সাথে মিল রাখে। সঙ্গে একবচন, দ্বিবচন আর বহুবচনের চেহারা।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "cap",
                minutes: 9,
                blurb: "শব্দের শেষে ـُ, ـَ বা ـِ। কে কর্তা, কে কর্ম, কে জোড়া-শব্দের পরে, সব ওই এক চিহ্নে।",
            },
            {
                slug: "tanvin",
                from: 16,
                ...
                icon: "ring",
                minutes: 7,
                blurb: "শেষের চিহ্ন দুবার হলে (ـٌ ـً ـٍ) শেষে একটা ن-এর আওয়াজ আসে, আর মানে দাঁড়ায় 'একটা'।",
            },
            {
                slug: "chinho-mane",
                from: 17,
                ...
                icon: "key",
                minutes: 8,
                blurb: "চিহ্নই কাজ বলে দেয় বলে আরবি শব্দের ক্রম বদলাতে পারে, আর মানে বদলায় না।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "eye",
                minutes: 8,
                blurb: "বেশির ভাগ ছাপা আরবিতে যের-যবর থাকে না। তিনটা সূত্র জানলে আওয়াজ নিজেই বসে যায়।",
            },
            {
                ...
                icon: "two",
                minutes: 8,
                blurb: "উপরে চিহ্নসহ, নিচে চিহ্ন ছাড়া। চেনা শব্দ চিহ্ন ছাড়াও চেনা লাগে, সেটাই প্রমাণ।",
            },
            {
                slug: "nije-poro",
                from: 20,
                ...
                icon: "open-book",
                minutes: 8,
                blurb: "চিহ্ন ছাড়া একটা লাইন। আগে নিজে চেষ্টা করো, তারপর মিলিয়ে নাও।",
            },
        ],
    },
];
        ...
        lessons: [
            {
                ...
                icon: "root",
                minutes: 9,
                blurb: "কুরআনের বেশির ভাগ ক্রিয়াই মূল রূপ নয়। কোন রূপ, সেটা চিনলে মানে আন্দাজ করা যায়।",
            },
            {
                slug: "rup-chena",
                from: 2,
                ...
                icon: "eye",
                minutes: 8,
                blurb: "মাঝে জোর? সামনে أ? সামনে اسْت? চিহ্ন তিনটা, আর তাতেই বেশির ভাগ রূপ ধরা পড়ে।",
            },
            {
                slug: "rup-dui",
                from: 3,
                ...
                icon: "strong",
                minutes: 8,
                blurb: "মাঝের অক্ষরে শাদ্দা বসে, আর মানে দাঁড়ায় জোর দিয়ে করা বা কাউকে দিয়ে করানো।",
            },
            {
                slug: "rup-char",
                from: 4,
                ...
                icon: "forward",
                minutes: 8,
                blurb: "সামনে একটা أ যোগ হয়, আর কাজটা অন্যের উপর গিয়ে পড়ে: أَنْزَلَ, أَخْرَجَ।",
            },
            {
                slug: "rup-at-dosh",
                from: 5,
                ...
                icon: "merge",
                minutes: 9,
                blurb: "ভেতরে একটা ت, আর সামনে اسْت। দ্বিতীয়টা মানে দাঁড়ায় 'চাওয়া': اسْتَغْفَرَ।",
            },
            {
                slug: "chena-line",
                from: 7,
                ...
                icon: "open-book",
                minutes: 8,
                blurb: "সূরা ফাতিহায় তুমি রোজ যা পড়ো, তার ভেতরেই এই রূপগুলো বসে আছে।",
            },
            {
                slug: "rup-chine-nao",
                from: 8,
                ...
                icon: "check",
                minutes: 7,
                blurb: "আটটা শব্দ, আর একটাই প্রশ্ন: চিহ্নটা কোথায়। আগে নিজে বলো, তারপর মিলিয়ে নাও।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "two",
                minutes: 8,
                blurb: "সহজ বহুবচনে শেষে ـُونَ বা ـَاتٌ জোড়ে। ভাঙা বহুবচনে শব্দটাই ভেঙে নতুন করে গড়া হয়।",
            },
            {
                ...
                icon: "star",
                minutes: 9,
                blurb: "قَلْب থেকে قُلُوب, كِتَاب থেকে كُتُب। মূলের তিন অক্ষর থাকে, শুধু আওয়াজ বদলায়।",
            },
            {
                ...
                icon: "open-book",
                minutes: 7,
                blurb: "চেনা আয়াতের ভেতরে ভাঙা বহুবচন খুঁজে বের করা: قُلُوبِهِمْ, السَّمَاوَات।",
            },
            {
                ...
                icon: "check",
                minutes: 7,
                blurb: "বহুবচন শব্দের মূল অক্ষর ধরে বলো এটা কোন একবচন থেকে এসেছে।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "two",
                minutes: 8,
                blurb: "কর্তাবাচ্যে কর্তা থাকে, কর্মবাচ্যে কাজটাই মুখ্য: 'সৃষ্টি করা হয়েছে'।",
            },
            {
                ...
                icon: "eye",
                minutes: 8,
                blurb: "চেনা যায় শুধু ভেতরের আওয়াজ দিয়ে: خَلَقَ হয়ে যায় خُلِقَ। অক্ষর একই, আওয়াজ আলাদা।",
            },
            {
                ...
                icon: "open-book",
                minutes: 7,
                blurb: "خُلِقَ الإِنْسَانُ ضَعِيفًا। কে সৃষ্টি করল বলা হয়নি, কারণ সেটা সবাই জানে।",
            },
            {
                ...
                icon: "check",
                minutes: 7,
                blurb: "ভেতরের আওয়াজ শোনো। পেশ-যের হলে কর্মবাচ্য, নাহলে কর্তাবাচ্য।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "strong",
                minutes: 7,
                blurb: "বাক্যের শুরুতে বসে জোর আনে, আর পরের শব্দটাকে যবর পরিয়ে দেয়।",
            },
            {
                slug: "allazi",
                from: 18,
                ...
                icon: "link",
                minutes: 8,
                blurb: "দুটো বাক্যকে এক করে দেয়। কুরআনের সবচেয়ে বেশি আসা গঠনগুলোর একটা।",
            },
            {
                slug: "kana",
                from: 19,
                ...
                icon: "back",
                minutes: 7,
                blurb: "নাম-বাক্যে 'হয়' লাগে না, কিন্তু অতীতে সেই জায়গাটা كَانَ নিয়ে নেয়।",
            },
            {
                slug: "iza",
                from: 20,
                ...
                icon: "clock",
                minutes: 8,
                blurb: "একটা শর্ত বা সময় বোঝায়, আর কুরআনের অনেক ছোট সূরা এই এক শব্দ দিয়ে শুরু।",
            },
            {
                slug: "ya-ayyuha",
                from: 22,
                ...
                icon: "call",
                minutes: 7,
                blurb: "ডাক দেওয়ার শব্দ। এটা শুনলেই বুঝবে পরের কথাটা সরাসরি তোমাকে বলা হচ্ছে।",
            },
            {
                ...
                icon: "check",
                minutes: 7,
                blurb: "প্রতিটি ছোট শব্দ কী আনে: জোর, সংযোগ, সময়, নাকি ডাক।",
            },
        ],
    },
    {
        ...
        lessons: [
            {
                ...
                icon: "key",
                minutes: 7,
                blurb: "গোটা সূরা ভয়ের কিছু নয়। একেকটা শব্দ ধরো, চেনাটা আগে চিনে নাও, বাকিটা আন্দাজ করো।",
            },
            {
                slug: "ikhlas",
                from: 25,
                ...
                icon: "open-book",
                minutes: 9,
                blurb: "চার আয়াত, আর হাদিসে একে কুরআনের এক-তৃতীয়াংশের সমান বলা হয়েছে।",
            },
            {
                slug: "nasr",
                from: 26,
                ...
                icon: "open-book",
                minutes: 8,
                blurb: "إِذَا দিয়ে শুরু, আর তিন আয়াতে একটা গোটা ঘটনা।",
            },
            {
                slug: "asr",
                from: 27,
                ...
                icon: "open-book",
                minutes: 8,
                blurb: "তিন আয়াতে পুরো জীবনের হিসাব। إِنَّ আর الَّذِينَ দুটোই এখানে আছে।",
            },
            {
                slug: "fatiha",
                from: 28,
                ...
                icon: "star",
                minutes: 10,
                blurb: "যে সূরা রোজ পড়ো, তার ভেতরে ষাট দিনের শেখা প্রায় সবটাই বসে আছে।",
            },
            {
                ...
                icon: "eye",
                minutes: 8,
                blurb: "চেনা সূরা, এবার যের-যবর ছাড়া। আগে নিজে পড়ার চেষ্টা, তারপর মিলিয়ে নেওয়া।",
            },
            {
                ...
                icon: "check",
                minutes: 8,
                blurb: "হারাকাত ছাড়া আরও দুটি চেনা লাইন। ধীরে ধীরে, অন্তর থেকে।",
            },
        ],
    },
];
...
export const DHAPS = [
    {
        ...
        blurb: "নাম-শব্দ, সর্বনাম, ছোট জোড়া-শব্দ আর 'আল'। কুরআনে যে শব্দগুলো বারবার আসে, প্রথমে সেগুলোই।",
        can: "১০ দিন পরে: বিসমিল্লাহ, আলহামদু লিল্লাহ আর সূরা ইখলাসের প্রথম আয়াত শব্দ ধরে ধরে বুঝতে পারবেন।",
        minutes: [20, 30],
        status: "live",
    ...
    },
    {
        ...
        blurb: "মূল ও ছাঁচ, ক্রিয়ার তিন কাল, বাক্যের দুই রকম গড়ন, শব্দের শেষের চিহ্ন, আর হারাকাত ছাড়া পড়া।",
        can: "২০ দিন পরে: একটা আয়াত দেখে বলতে পারবেন কে করল, কী করল আর কার জিনিস। আর যের-যবর ছাড়া লেখা চেনা লাইনও পড়তে পারবেন।",
        minutes: [25, 35],
        status: "live",
    ...
    },
    {
        ...
        blurb: "ক্রিয়ার রূপ, ভাঙা বহুবচন, কর্মবাচ্য, বাক্যের হাতিয়ার, আর চারটা সূরা শব্দ ধরে ধরে।",
        can: "৩০ দিন পরে: ইখলাস, নাসর, আসর আর ফাতিহা শব্দ ধরে ধরে বুঝতে পারবেন, আর নতুন কোনো ছোট সূরা নিজে খুলে বসতে পারবেন।",
        minutes: [30, 40],
        status: "live",
...
export const dhapLessons = (dhap) => dhap.sections.flatMap((section) => section.lessons.map((lesson) => ({
    ...lesson,
    dhap,
    section,
...
export const dhapMinutes = (dhap) => dhapLessons(dhap).reduce((sum, l) => sum + (l.minutes ?? 0), 0);
/** Find a ধাপ by slug. */
export const findDhap = (slug, stages = DHAPS) => stages.find((d) => d.slug === slug);
/** Find a lesson (and its ধাপ) from a URL path. */
export const findByPath = (path, stages = DHAPS) => allLessons(stages).find((l) => l.url === path || l.url === `${path}.html`);
