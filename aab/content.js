...
export const PAGES = [
  ...
  { title: "Learn: সব বিষয় এক নজরে", url: "/learn/contents.html",
    hint: "Page", group: "learn", blurb: "Every lesson in the Learn area on one page, plus the A–Z of terms.", menu: false },
  ...
  { title: "৩০ দিনের অনুশীলন খাতা · Das 30-Tage-Arbeitsbuch", url: "/deutsch/stufe-1/arbeitsbuch.html",
    hint: "Workbook", group: "deutsch", blurb: "One page a day: a pattern, five models, eight of your own sentences, six translations, and one true paragraph.", menu: false },
  ...
  { title: "Stock check: buy, hold or sell", url: "/tools/stock.html",
    hint: "Tool", group: "tool", blurb: "Thirty-odd ratios across six pillars, a verdict that shows its own arithmetic, in English or Bangla.", menu: false },
  ...
  { title: "Three-statement model: interactive case study", url: "/portfolio/three-statement.html",
    hint: "Case study", group: "case", blurb: "A live financial model: edit the assumptions, watch all three statements move.", menu: false },
  { title: "DCF with sensitivity tables: interactive case study", url: "/portfolio/dcf.html",
    hint: "Case study", group: "case", blurb: "A live discounted cash flow: build the WACC, switch terminal value method, read the grid.", menu: false },
  { title: "Index volatility & drawdowns: interactive case study", url: "/portfolio/dsex.html",
    hint: "Case study", group: "case", blurb: "Rolling volatility, drawdowns, tail risk and holding periods, with CSV import.", menu: false },
  { title: "Islamic vs conventional funds: MSc dissertation", url: "/portfolio/dissertation.html",
    hint: "Case study", group: "case", blurb: "220 UK funds, 19,577 fund-months, five-factor models, and what a sample of three could actually detect.", menu: false },
